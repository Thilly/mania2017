...
var plank_duration = reality.UNIVERSAL_DURATION();
var HUMAN_PLANKS = 12016;  // "https://www.youtube.com/watch?v=czgOWmtGVGs" -Kurzgesagt – In a Nutshell
var reality_plank_duration = plank_duration / HUMAN_PLANKS;
...
function observe_reality(plank_duration) {
...
function statistically_predict_subjective_goal(plank_duration, plank_step, depth) {
  ...
  var subjective_sucess_probability = 1;  // “I believe in everything until it's disproved. So I believe in fairies, the myths, dragons. It all exists, even if it's in your mind. Who's to say that dreams and nightmares aren't as real as the here and now?” ― John Lennon
  ...
  var subjective_future_goal = look_inward(plank_duration, plank_step, depth+1);  //think
  function look_inward(inward_plank_duration, inward_plank_step, inward_depth) {
    ...
    do {
      ...
      new_predictions.push(subjective_prediction);//multi dimensional spin
      ...
      subjective_sucess_probability = (subjective_sucess_probability + find_subjective_success_value(new_predictions)) * .5;
      function find_subjective_success_value(predictions) {
        return aggregate_history(predictions);
      }
      console.log('subjective_sucess_probability: ' + subjective_sucess_probability);
      ...
      if (subjective_improvement_probability > SUBJECTIVE_IMPROVEMENT) {
        ...
        function decide() {
          ...
          if (pondered_observations['success'] > SUBJECTIVE_SUCCESS) {
      ...
      subjective_history.push({
        ...
        'success': subjective_sucess_probability,
