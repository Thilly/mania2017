  ...
  'products'
    open source software (games, tools)
    open source math (algos, continuity)
    open source philosophy (art, writing, teaching)
  ...
  'flagship product'
    ...
    'plank learning'
      any and every medium.
       limit is only size
      single plank of all natural information
  ...
  'end game'
    fill the universe with original content
